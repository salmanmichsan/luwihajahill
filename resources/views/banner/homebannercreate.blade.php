			...
			<div class="mt-2 mb-4">
				<div class="card">	
					<div class="container mt-4 mb-4">	
						...
						<h2 class="text-black pb-2">Create Home Banner</h2>
						<form method="post" action="{{Route('homebannersave')}}" enctype="multipart/form-data">
							@csrf
							<!-- <div class="form-group">	 -->
					            ...
					            <div class="imageupload panel panel-default">
					                ...
					                <div class="file-tab panel-body">
					                	<img src="" alt="Image preview" class="thumbnail" id="preview_img" style="max-width: 250px; max-height: 250px">
					                	<br>
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="caption" id="@error('caption') errorInput @enderror" rows="3">{{ old('title') }}</textarea>
								@error('caption')
                                <small id="emailHelp" class="form-text text-danger">{{$message}}</small>
                                @enderror
							</div>
							<div class="form-check">
								<input type="checkbox" class="form-check-input" name="active" id="exampleCheck1" style="left :80px;" value="{{ old('title') }}">
