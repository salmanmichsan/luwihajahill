			...
			<div class="mt-2 mb-4">
				<div class="card">	
					<div class="container mt-4 mb-4">	
						...
						<form method="post" action="{{Route('wahanasave')}}" enctype="multipart/form-data">
							@csrf
							...
							<div class="form-group">
								...
								<div class="selectgroup w-100">
									<label class="selectgroup-item">
										<input type="radio" name="category" value="Curug" class="selectgroup-input">
										<span class="selectgroup-button">Curug</span>
									</label>
									<label class="selectgroup-item">
										<input type="radio" name="category" value="River Tubing" class="selectgroup-input">
										<span class="selectgroup-button">River Tubing</span>
									</label>
									<label class="selectgroup-item">
										<input type="radio" name="category" value="Spot Foto Instagramable" class="selectgroup-input">
